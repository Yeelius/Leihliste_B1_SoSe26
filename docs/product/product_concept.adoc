...
- relationale Datenbank als Speicherort, API, Frontend ist Website zum Durchklicken
- html-Vorkenntnisse sind mäßig vorhanden, aber schnell erlernbar
- Datenbank-Vorkenntnisse gibt es auch
- Programmiersprache: Python oder JavaScript
- Datenbank: MySQL
...
| Verleiher
| Eigentümer der technischen Geräten, Laborzubehör und Medien
| Nachverfolgbarkeit, eine Historie, ein klares Ausleihverfahren und eine Zustandsdokumentaion(vor/nach Nutzung)
| Hoch

| Ausleiher
| Personen die Gegenstände ausleihen möchten
| einfaches Ausleihverfahren, transparente Anzeige(Verfügbarkeit), einfacher Verlängerungsprozess, Erinnerungen an Fristen
| Mittel

| Portalbetreiber
| Betreiber der Website
| Stabiler Betrieb, geringe Supportkosten und Differenzierung gegenüber Konkurrenz
| Hoch

| Gesetzgeber
| geben gesetzliche Bedingungen vor
| saubere Protokollierung, Einhaltung von Gesetzen und Vorschriften 
| Hoch

| Konkurrenz
| alternative Anbieter
| Wettbewerbsdynamik, Reaktionen auf Innovationen
| Mittel




| _Hochschulverwaltung ?_
